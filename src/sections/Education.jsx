  ...
  return (
    ...
    >
      ...
      <div className="relative w-full">
        <div
          className="relative flex min-h-46.5 items-center justify-center overflow-hidden rounded-[25px] bg-brand px-8 py-8 text-center"
          style={{
            backgroundImage:
        ...
        <div className="relative mx-auto -mt-16 w-[95%] rounded-[25px] bg-white p-6 shadow-[0px_0px_2px_rgba(150,133,231,0.24)] sm:p-10 lg:w-268">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:gap-5">
            <div className="flex size-22.25 shrink-0 items-center justify-center rounded-2xl bg-brand/10">
